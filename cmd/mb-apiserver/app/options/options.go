...
import (
	...
	genericoptions "github.com/TobyIcetea/miniblog/pkg/options"
...
type ServerOptions struct {
	...
	// Expiration 定义了 JWT Token 的过期时间
...
func (o *ServerOptions) AddFlags(fs *pflag.FlagSet) {
	// StringVar() 第三个参数表示默认值
	fs.StringVar(&o.ServerMode, "server-mode", o.ServerMode, fmt.Sprintf("Server mode, available: %v", availableServerModes.UnsortedList()))
	...
	fs.DurationVar(&o.Expiration, "expiration", o.Expiration, "The expiration time of JWT Token.")
